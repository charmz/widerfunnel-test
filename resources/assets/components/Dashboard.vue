            ...
            <div class="box">
                ...
                <div class="field has-addons">
                    <div class="control is-expanded">
                        <input class="input" type="text" placeholder="New note" v-model="note.body">
                    </div>
                    <div class="control">
                        <a class="button is-primary" @click="createNote()">
                            Add note
                        </a>
                    </div>
                </div>
<div class="tabs is-centered">
                ...
                <div class="card" v-for="note in list">
                    ...
                    <footer class="card-footer">
                        <a class="card-footer-item" v-on:click.prevent="deleteNote(note.id)">Delete</a>
                    </footer>
                </div>
            </div>
        </div>
